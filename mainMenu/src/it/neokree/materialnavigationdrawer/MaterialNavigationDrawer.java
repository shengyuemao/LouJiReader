...
/**
 * Activity that extends ActionBarActivity with a Navigation Drawer with
...
public abstract class MaterialNavigationDrawer<Fragment> extends
		ActionBarActivity implements MaterialSectionListener,
		MaterialAccount.OnAccountDataLoaded
{
	...
	private View.OnClickListener secondAccountListener = new View.OnClickListener()
	{
		...
		public void onClick(View v)
		{
			if (!drawerTouchLocked)
			{
				...
				{// if there is no second account user clicked for open it
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		theme.resolveAttribute(android.R.attr.colorPrimaryDark, typedValue,
				true);
		...
		} else
		{
			...
			pulsante = new MaterialActionBarDrawerToggle<Fragment>(this,
					layout, toolbar, R.string.nothing, R.string.nothing)
			{
	...
	{// al cambio di orientamento dello schermo
	...
	public void setFragment(Fragment fragment, String title)
	{
		...
		{// remove the last child from the stack
			...
			{ // if a section is clicked when user is into a child remove all
				// childs from stack
			...
			Fragment oldFragment, boolean hasSavedInstanceState)
	{
		...
		} else if (fragment instanceof android.app.Fragment)
		{
			...
			if (!hasSavedInstanceState)
			{// se non e' avvenuta una rotazione
	...
	public void changeToolbarColor(MaterialSection section)
	{
		...
		this.getToolbar().setTitleTextColor(0xffffffff);
		this.getToolbar().setNavigationIcon(drawerArrowDrawable);
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
			statusBar.setImageDrawable(new ColorDrawable(
