...
import com.louji.base.R.id;
import com.louji.base.R.layout;
import com.louji.base.R.menu;
...
public class ReadActivity extends ActionBarActivity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		View view = LayoutInflater.from(this).inflate(R.layout.readbookfragment, null);
		setContentView(view);
		initView(view);
	}
	...
	private void initView(View view)
	{
		...
		searchDlg.setOnDismissListener(new OnDismissListener()
		{
			...
			public void onDismiss(DialogInterface dialog)
			{
				...
				{
					Toast.makeText(ReadActivity.this, "没有找到关键字", Toast.LENGTH_LONG)
							.show();
				}
			}
		});
		...
		try
		{
			...
			SharedPreferences spSetting = getSharedPreferences(
					SettingsActivity.PANDA_READER_PREF, 0);
			String fontColor = spSetting.getString(
					SettingsActivity.PREF_TAG_FONT_COLOR, "白色");
			String bgColor = spSetting.getString(
					SettingsActivity.PREF_TAG_BACKGROUND_COLOR, "黑色");
			float fontSize = spSetting.getFloat(SettingsActivity.PREF_TAG_FONT_SIZE,
					25.0f);
			float scrBrightness = spSetting.getFloat(
					SettingsActivity.PREF_TAG_SCREEN_BRIGHTNESS, 1.0f);
